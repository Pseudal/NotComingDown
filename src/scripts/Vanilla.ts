...
export function VanillaElseIfHell(ent, EntSprite, data, IRFconfig, spawnTracer, RemoveLaserIndicator, AfterDedLaserIndicator, TargetLaserIndicator):void {
if (ent.Type == 241){
  ...
  //Adversary
    ...
    if( (EntSprite.IsPlaying("Attack01") && EntSprite.FlipX == false && EntSprite.GetFrame() < 30))
      spawnTracer(ent, 90, [4], 40, 2, 0, 0)
    if((EntSprite.IsPlaying("Attack01") && EntSprite.FlipX == true && EntSprite.GetFrame() < 30))
    ...
    if((EntSprite.IsPlaying("BlastStart")&& EntSprite.GetFrame() >= 23) || EntSprite.IsPlaying("Blasting")){
      if(data.IndicatorBrim){
        data.Danger = 0;
        RemoveLaserIndicator(ent)
      }
  ...
  //eye need fix
    ...
    if( (EntSprite.IsPlaying("Attack3BeamStart") && EntSprite.GetFrame() < 23 && data.Ambiguous == false)){
    ...
    if((EntSprite.IsPlaying("AttackAlt01") || EntSprite.IsPlaying("AttackAlt02")) && EntSprite.GetFrame() > 10){
      if(data.IndicatorBrim){
        data.Danger = 0;
        RemoveLaserIndicator(ent)
      }
    ...
    if(ent.Variant == 0){
      if((EntSprite.IsPlaying("LaserStartDown") && EntSprite.GetFrame() > 26) && (ent.ToNPC().State == 10 || ent.ToNPC().State == 9|| ent.ToNPC().State == 11))
        spawnTracer(ent, 90, [1], 30, 2, 0, 0)
      if((EntSprite.IsPlaying("LaserStartSide") && EntSprite.GetFrame() > 26) && (EntSprite.FlipX == true && ent.ToNPC().State == 10|| ent.ToNPC().State == 11))
        spawnTracer(ent, 90, [2], 30, 2, 0, 0)
      if((EntSprite.IsPlaying("LaserStartSide") && EntSprite.GetFrame() > 26) && EntSprite.FlipX == false && (ent.ToNPC().State == 10 || ent.ToNPC().State == 9|| ent.ToNPC().State == 11))
        spawnTracer(ent, 90, [4], 30, 2, 0, 0)
      if((EntSprite.IsPlaying("LaserStartUp") && EntSprite.GetFrame() > 26) && (ent.ToNPC().State == 10 || ent.ToNPC().State == 9|| ent.ToNPC().State == 11))
        spawnTracer(ent, 90, [3], 30, 2, 0, 0)
    }
    if((EntSprite.IsPlaying("LaserLoopDown") || EntSprite.IsPlaying("LaserLoopUp")|| EntSprite.IsPlaying("LaserLoopSide"))){
      if(data.IndicatorBrim){
        data.Danger = 0;
        RemoveLaserIndicator(ent)
      }
    ...
    if(ent.Variant == 1){
      if((EntSprite.IsPlaying("AttackDown") && EntSprite.GetFrame() < 13) && (ent.ToNPC().State == 108 ))
        spawnTracer(ent, 90, [1], 30, 2, 0, 0)
      if((EntSprite.IsPlaying("AttackLeft") && EntSprite.GetFrame() < 13) && (ent.ToNPC().State == 108 ))
        spawnTracer(ent, 90, [2], 30, 2, 0, 0)
      if((EntSprite.IsPlaying("AttackRight") && EntSprite.GetFrame() < 13) && (ent.ToNPC().State == 108 ))
        spawnTracer(ent, 90, [4], 30, 2, 0, 0)
      if((EntSprite.IsPlaying("AttackDown") && EntSprite.GetFrame() < 13) && (ent.ToNPC().State == 108 ))
        spawnTracer(ent, 90, [3], 30, 2, 0, 0)
    }
    if((EntSprite.IsPlaying("AttackDown") || EntSprite.IsPlaying("AttackLeft")|| EntSprite.IsPlaying("AttackRight")|| EntSprite.IsPlaying("AttackDown")) && EntSprite.GetFrame() > 13 && ent.ToNPC().State == 108){
      if(data.IndicatorBrim){
        data.Danger = 0;
        RemoveLaserIndicator(ent)
      }
